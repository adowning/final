                        ...
                        if (slotSettings.increaseRTP && winType == 'win' && totalWin < (minWin * allbet)) {
                            ...
                            if (cBank < spinWinLimit) {
                                ...
                                const serverResponse = {
                                    ...
                                    slotLines: lines,
                                    slotBet: betline,
                                    totalFreeGames: slotSettings.GetGameData('FruitShopNETFreeGames'),
                                    currentFreeGames: slotSettings.GetGameData('FruitShopNETCurrentFreeGame'),
                                    Balance: balanceInCents,
                                    afterBalance: balanceInCents,
                                    bonusWin: slotSettings.GetGameData('FruitShopNETBonusWin'),
                                    totalWin: totalWin,
                                    winLines: [],
