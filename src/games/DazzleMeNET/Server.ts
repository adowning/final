        ...
        try {
            ...
            if (slotSettings.GetGameData(slotSettings.slotId + 'FreeGames') < slotSettings.GetGameData(slotSettings.slotId + 'CurrentFreeGame') && postData.slotEvent === 'freespin') {
                return JSON.stringify({
                    responseEvent: 'error',
                    responseType: postData.slotEvent,
                    serverResponse: 'invalid bonus state'
                });
            }
            ...
            switch (aid) {
                case 'init':
                    ...
                    curReels += `&rs.i0.r.i2.syms=SYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}`;
                    curReels += `&rs.i0.r.i3.syms=SYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}`;
                    curReels += `&rs.i0.r.i4.syms=SYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}%2CSYM${Math.floor(Math.random() * 7) + 1}`;
